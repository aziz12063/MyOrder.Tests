...
//        public async Task<List<BestSellerItemDto?>?> GetBasketBestSellersAsync(string companyId, string basketId, string? filter = null)
//        {
...
//        public async Task<List<OrderedItemDto?>?> GetBasketOrderedItemsAsync(string companyId, string basketId, string? filter = null)
//        {
//            var jsonFilePath = Path.Combine(baseDataPath, "orderedItems.json");
//            if (!File.Exists(jsonFilePath))
//                return null;
...
//        public async Task<List<BasketItemDto?>?> GetBasketSearchItemsAsync(string companyId, string basketId, string? filter = null)
//        {
//            var jsonFilePath = Path.Combine(baseDataPath, "orderedItems.json");
//            if (!File.Exists(jsonFilePath))
//                return null;
...
//        }
//        public async Task<ProcedureCallResponseDto?> CommitAddFreeTextLineAsync(string companyId, string basketId, List<string?> freeTexts)
//        {
...
//        public Task<ProcedureCallResponseDto> DuplicateOrderLinesAsync(string companyId, string basketId, List<int> linesIds)
//        {
//            throw new NotImplementedException();
//        }

//        public Task<ProcedureCallResponseDto> DeleteOrderLinesAsync(string companyId, string basketId, List<int> linesIds)
//        {
//            throw new NotImplementedException();
//        }

//        Task<List<ContactDto?>> GetOrderByContactsAsync(string companyId, string basketId, string? filter)
//        {
//            throw new NotImplementedException();
//        }

//        Task<List<AccountDto?>> GetDeliverToAccountsAsync(string companyId, string basketId, string? filter)
//        {
//            throw new NotImplementedException();
//        }

//        Task<List<ContactDto?>>GetDeliverToContactsAsync(string companyId, string basketId, string? filter)
//        {
//            throw new NotImplementedException();
//        }

//        public Task<List<AccountDto?>> GetInvoiceToAccountsAsync(string companyId, string basketId, string? filter = null)
//        {
//            throw new NotImplementedException();
//        }
//    }
