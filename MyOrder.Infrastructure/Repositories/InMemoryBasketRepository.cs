...
//        private static readonly Dictionary<string, BasketNotificationsDto> _basketsNotification = [];
...
//        public async Task<BasketNotificationsDto> GetNotificationsAsync(string basketId)
//        {
//            await Task.Delay(_millisecondsTimeout);
